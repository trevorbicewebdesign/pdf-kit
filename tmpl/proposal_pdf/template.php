...
$proposal  = ($displayData['proposal'] ?? null);
...
<head>
    <meta charset="UTF-8">
    <title>Proposal #<?php echo htmlspecialchars($proposal['number']); ?></title>
    <style>
    ...
    <tr valign="top">
        ...
        <td style="width: 50%; vertical-align: top; text-align: right;">
            <div class="header-right">
                <h1 style="font-weight:300;letter-spacing:1pt;">Proposal for Services</h1>
...
<img src="<?php echo $imgHr; ?>" alt="Separator" style="width: 100%; height: 1px; margin: 0px;" />
<div class="section account-heading">
    <?php echo htmlspecialchars($account['name'] ?? ''); ?><br/>
    <h6 style="margin:0px;padding:0px;margin-top:2mm;"><?php echo htmlspecialchars($proposal['title'] ?? ''); ?></h6>
</div>
    ...
    <table class="items-table">
        ...
        <?php foreach ($items as $item): ?>
            ...
            <tr style="<?php echo $rowStyle; ?>">
                <td><img src="<?php echo $imgBullet; ?>" alt="•" style="width:16px;height:auto;" /></td>
...
<table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 6mm;">
    <tr valign="bottom">
        ...
        <td style="text-align: right; vertical-align: bottom;">
            <div class="total">
                AMOUNT DUE: $<?php echo number_format((float)($proposal['total'] ?? 0), 2); ?><br>
